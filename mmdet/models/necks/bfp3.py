...
class BFP3(nn.Module):
    ...
    def forward(self, inputs):
        ...
        feat.append(gathered2)
        bsf = sum(feat) / len(feat)
        bsf = self.refine3[self.num_levels-1](bsf)
        feats.append(bsf)        
